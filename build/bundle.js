...
/***/ function(module, exports, __webpack_require__) {
	...
	var CanvasRenderer_1 = __webpack_require__(157);
	var DocumentManager_1 = __webpack_require__(163);
	React.render(React.createElement(CanvasRenderer_1.CanvasRenderer, {"model": DocumentManager_1.documentManager.canvas}), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ObservableRenderer_1 = __webpack_require__(158);
	var canvasEvents_1 = __webpack_require__(159);
	var PathRenderer_1 = __webpack_require__(161);
	var CanvasRenderer = (function (_super) {
	    ...
	    CanvasRenderer.prototype.componentDidMount = function () {
	        _super.prototype.componentDidMount.call(this);
	        var model = this.props.model;
	        model.elements.collectionChanged.listen(this.onPropertyChange, this);
	    };
	    CanvasRenderer.prototype.componentWillUnmount = function () {
	        _super.prototype.componentWillUnmount.call(this);
	        var model = this.props.model;
	        model.elements.collectionChanged.unlisten(this.onPropertyChange);
	    };
	    CanvasRenderer.prototype.handleMouse = function (event) {
	        var info = new canvasEvents_1.MouseInfo();
	        info.x = event.pageX - event.target.offsetLeft;
	        info.y = event.pageY - event.target.offsetTop;
	        canvasEvents_1.dispatcher.emit(event.type, info);
	    };
	    CanvasRenderer.prototype.render = function () {
	        var _this = this;
	        var canvas = this.props.model;
	        var elements = canvas.elements.source;
	        return (React.createElement("svg", {"width": 400, "height": 300, "onMouseDown": this.handleMouse, "onMouseMove": this.handleMouse, "onMouseUp": this.handleMouse, "onMouseLeave": this.handleMouse}, elements.map(function (element) {
	            var key = _this.id++;
	            return React.createElement(PathRenderer_1.PathRenderer, {"key": key, "model": element});
	        })));
	    };
	    return CanvasRenderer;
	})(ObservableRenderer_1.ObservableRenderer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ObservableRenderer = (function (_super) {
	    __extends(ObservableRenderer, _super);
	    function ObservableRenderer() {
	        _super.apply(this, arguments);
	    }
	    ObservableRenderer.prototype.componentDidMount = function () {
	        var model = this.props.model;
	        model.propertyChanged.listen(this.onPropertyChange, this);
	    };
	    ObservableRenderer.prototype.onPropertyChange = function (info) {
	        this.forceUpdate();
	    };
	    ObservableRenderer.prototype.componentWillUnmount = function () {
	        var model = this.props.model;
	        model.propertyChanged.unlisten(this.onPropertyChange);
	    };
	    ObservableRenderer.prototype.render = function () {
	        throw new Error("Render needs to be implemented in child classes");
	        return null;
	    };
	    return ObservableRenderer;
	})(React.Component);
	exports.ObservableRenderer = ObservableRenderer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.MouseInfo = MouseInfo;
	var CanvasEvents = (function (_super) {
	    __extends(CanvasEvents, _super);
	    function CanvasEvents() {
	        _super.apply(this, arguments);
	    }
	    Object.defineProperty(CanvasEvents, "MouseMove", {
	        get: function () { return 'mousemove'; },
	        enumerable: true,
	        configurable: true
	    });
	    ;
	    Object.defineProperty(CanvasEvents, "MouseUp", {
	        get: function () { return 'mouseup'; },
	        enumerable: true,
	        configurable: true
	    });
	    ;
	    Object.defineProperty(CanvasEvents, "MouseDown", {
	        get: function () { return 'mousedown'; },
	        enumerable: true,
	        configurable: true
	    });
	    ;
	    Object.defineProperty(CanvasEvents, "MouseLeave", {
	...
	exports.dispatcher = new CanvasEvents();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ObservableRenderer_1 = __webpack_require__(158);
	var SimplePath_1 = __webpack_require__(162);
	var PathRenderer = (function (_super) {
	    __extends(PathRenderer, _super);
	    function PathRenderer() {
	        _super.apply(this, arguments);
	    }
	    PathRenderer.prototype.componentDidMount = function () {
	        _super.prototype.componentDidMount.call(this);
	        var model = this.props.model;
	        model.points.collectionChanged.listen(this.onPropertyChange, this);
	    };
	    PathRenderer.prototype.componentWillUnmount = function () {
	        _super.prototype.componentWillUnmount.call(this);
	        var model = this.props.model;
	        model.points.collectionChanged.unlisten(this.onPropertyChange);
	    };
	    PathRenderer.prototype.render = function () {
	        var drawing = this.props.model;
	        var data = "";
	        var points = drawing.points.source;
	        if (points.length > 0) {
	            var point = points[0];
	        ...
	        return React.createElement(SimplePath_1.SimplePath, {"data": data, "stroke": 0x000000, "strokeWidth": 2});
	    };
	    return PathRenderer;
	})(ObservableRenderer_1.ObservableRenderer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ts_undoredo_1 = __webpack_require__(164);
	var Canvas_1 = __webpack_require__(171);
	var DocumentManager = (function () {
	    function DocumentManager() {
	        this._undoredo = new ts_undoredo_1.UndoRedo();
	        this._canvas = new Canvas_1.Canvas();
	    }
	    Object.defineProperty(DocumentManager.prototype, "canvas", {
	        get: function () {
	            return this._canvas;
	        },
	        enumerable: true,
	    ...
	    Object.defineProperty(DocumentManager.prototype, "undoRedo", {
	        get: function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var commands_1 = __webpack_require__(165);
	...
	var recorder_1 = __webpack_require__(166);
	exports.Recorder = recorder_1.Recorder;
	var undoredo_1 = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var commands = __webpack_require__(165);
	var ts_observable_1 = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var observableCollection_1 = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ts_observable_1 = __webpack_require__(172);
	var Canvas = (function (_super) {
	    __extends(Canvas, _super);
	    function Canvas() {
	        _super.call(this);
	        this._elements = new ts_observable_1.ObservableCollection();
	    }
	    Object.defineProperty(Canvas.prototype, "elements", {
	        get: function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PropertyChangeEvent = observable_1.PropertyChangeEvent;
	exports.PropertyChangeInfo = observable_1.PropertyChangeInfo;
	var observableCollection_1 = __webpack_require__(174);
	exports.ObservableCollection = observableCollection_1.ObservableCollection;
	exports.CollectionChangeEvent = observableCollection_1.CollectionChangeEvent;
	exports.CollectionChangeInfo = observableCollection_1.CollectionChangeInfo;
	exports.CollectionChangeAction = observableCollection_1.CollectionChangeAction;
